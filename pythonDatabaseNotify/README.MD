A telegram bot for push notifications for an electronic device connected to a personal cloud database (firebase) to notify user about changes in data of the device.
